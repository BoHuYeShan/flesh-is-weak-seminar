...
onMounted(async () => {
  try {
    const res = await fetch('https://api.github.com/repos/BoHuYeShan/flesh-is-weak-seminar/discussions?category=General')
...
<div v-else-if="items.length === 0" class="empty">暂无讨论</div>
